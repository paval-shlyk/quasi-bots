...
impl SkillMasterMcpServer {
    ...
    async fn knowledge_next_question(&self) -> Result<rmcp::handler::server::wrapper::Json<serde_json::Value>, String> {
    ...
    async fn knowledge_list_topics(&self) -> Result<rmcp::handler::server::wrapper::Json<serde_json::Value>, String> {
    ...
    async fn knowledge_list_tags(&self) -> Result<rmcp::handler::server::wrapper::Json<serde_json::Value>, String> {
    ...
    #[tool(description = "Set review affinity for a topic (days until next review, 0 to clear)")]
    ...
    #[tool(description = "Set review affinity for an entry (days until next review, 0 to clear)")]
    async fn knowledge_set_entry_affinity(
        &self,
        Parameters(EntryAffinity { entry_name, days }): Parameters<EntryAffinity>,
    ) -> Result<String, String> {
