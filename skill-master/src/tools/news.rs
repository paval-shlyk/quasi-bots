...
impl SkillMasterMcpServer {
    ...
    async fn news_bank_today(&self) -> Result<Json<news::TodayNews>, String> {
    ...
    async fn news_bank_broken_links(
        &self,
    ...
    async fn news_bank_source_statistics(
        &self,
    ...
    async fn news_bank_topics(
        &self,
    ) -> Result<Json<news::NewsTopicList>, String> {
